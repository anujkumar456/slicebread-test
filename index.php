...
?>
      ...
      <div class="col-md-6 col-md-offset-3">
             ...
             <h4><strong>  <i class="fa fa-check-circle-o"></i>Welcome to client-portal upload area !</strong></h4>
             <p>Click here to access project <a href="project.php">Client Project</a></p>
             </div>
          </div>          
        </div>
<?php
